...
export default class HomePage extends Component {
  constructor() {
    ...
    this.state = {
      data: [],
      isFlipped: false,
      orientation: screen.isPortrait(document) ? "portrait" : "landscape",
    };
  ...
  componentWillUnmount() {
    window.removeEventListener("resize", () => {
      this.setState({
        screensize: this.screen.isPortrait(document) ? "portrait" : "landscape",
      });
    });
  }
      ...
      return (
        <Container>
          <head>
            ...
            <meta
              name="viewport"
              content="width=width, initial-scale=1, minimum-scale=1"
            />
          </head>
          ...
          <MediaQuery query="(max-width: 896px)">
            ...
            <BetterAboutMe style={{ padding: "2rem 0" }}>
              <FlipCard>
                ...
                <Back>
                  I'm a UCLA CS Major. I got bored one day and decided to create
                  this website to keep track of my progress on some projects and
                  showcase my past works.
                </Back>
              </FlipCard>
            </BetterAboutMe>
          </MediaQuery>
          <Desktop>
            ...
            <BetterHeader style={{ height: "90vh" }}>
              <HeaderText
                data-aos="fade-right"
                style={{ fontFamily: "Girassol", fontSize: "4rem" }}
              >
                J. Ho
              </HeaderText>
              <HeaderText
                data-aos="fade-right"
                data-aos-delay="400"
                style={{ fontFamily: "Dancing Script", fontSize: "3.5rem" }}
              >
                Off
              </HeaderText>
              <HeaderText
                data-aos="fade-right"
                daa-aos-delay="800"
                style={{ fontFamily: "Abel", fontSize: "2rem" }}
              >
                the
              </HeaderText>
              <HeaderText
                data-aos="fade-right"
                data-aos-delay="1200"
                style={{ fontFamily: "Courier Prime", fontSize: "3.6rem" }}
              >
                Clock
              </HeaderText>
            </BetterHeader>
        ...
        <Container>
          ...
          <MobilePortrait>
            <BetterHeader style={{ height: "95vh" }}>
              <HeaderText
                data-aos="fade-right"
                style={{ fontFamily: "Girassol", fontSize: "3.5rem" }}
              >
                J. Ho
              </HeaderText>
              <HeaderText
              ...
              <HeaderText
                data-aos="fade-right"
                daa-aos-delay="800"
                style={{ fontFamily: "Abel", fontSize: "1.5rem" }}
              >
                the
              </HeaderText>
              <HeaderText
                data-aos="fade-right"
                data-aos-delay="1200"
                style={{ fontFamily: "Courier Prime", fontSize: "3.1rem" }}
              >
                Clock
              </HeaderText>
            </BetterHeader>
